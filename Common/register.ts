...
function massRegister<T extends ChatInputCommandInteraction | ContextMenuCommandInteraction, U extends { Command?: Command<T>, Event?: Event<T> }>(
    dir: string, 
    paths: string[], 
    property: keyof U
...
export function massRegisterCommands<T extends ChatInputCommandInteraction | ContextMenuCommandInteraction>(dir: string, paths: string[]): Command<T>[] {
    return massRegister<T, { Command: Command<T> }>(dir, paths, 'Command');
}

export function massRegisterEvents<T extends ChatInputCommandInteraction | ContextMenuCommandInteraction>(dir: string, paths: string[]): Event<T>[] {
