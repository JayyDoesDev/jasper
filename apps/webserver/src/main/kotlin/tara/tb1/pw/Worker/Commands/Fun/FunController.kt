        ...
        private fun sanitizeMemeData(data: MemeData): Map<String, Any> {
                ...
                val styleString = buildString {
                        ...
                        if (data.strokeColor != null) {
                                ...
                                append(
                                        "text-shadow: 3px 3px 0 $stroke, -3px -3px 0 $stroke, 3px -3px 0 $stroke, -3px 3px 0 $stroke, 0 3px 0 $stroke, 3px 0 0 $stroke, 0 -3px 0 $stroke, -3px 0 0 $stroke !important; "
                                )
                        }
                }
                ...
                return mapOf(
                                ...
                                "style-inline" to styleString,
                                "style-class" to memeStyleClass
                        )
