...
export const ListSubCommand = defineSubCommand({
    ...
    handler: async (ctx: Context, interaction: ChatInputCommandInteraction) => {
        ...
        const tagsResponse = await ctx.services.tags.getMultiValues<Snowflake, TagResponse[]>(guildId);
            ...
            embeds: [
                {
                    ...
                    description: state.tagPages[state.page]
                        ...
                        .join("\n"),
                    footer: { text: `Page: ${state.page + 1}/${state.tagPages.length} • Total Tags: ${tagsResponse.length}` },
